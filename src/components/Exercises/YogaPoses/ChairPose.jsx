...
import chairGif from '../../../media/chairGif.gif'
  ...
  return radians * (180/pi);
    ...
    const canvasCtx = canvasElement.getContext('2d');
     ...
     //   angleright_a=180-angleright_a;
       ...
       if(((angleleft<=93 && angleleft>=62) &&  angleleft_a<40) 
             || ((angleright<=95 && angleright>=75) && angleright_a<40)
       )
       
       {
         ...
         setTimeout(add,1000)
             ...
             if(angleleft>93 || angleright>93){
                 document.getElementById("message").innerHTML="Straight Up Your Arms";
             }
    ...
    <div className="ex-container">
      ...
      <video
        ...
        <div className="gif-container">
          <img className='gif' src={chairGif} alt="" />
        </div>
        </div>
      </div>
