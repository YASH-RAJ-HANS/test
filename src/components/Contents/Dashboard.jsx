...
import chairIcn from '../../media/chairIcn.png'
     ...
     <div className="row-left">
        ...
        <div className="suggested-exercises">
          <h3 className='sugg-text'>Suggested Exercises</h3>
            <SuggestedExercise name="Plank" time="60s" exerciseIcn={plankIcn} path='/home/train-yoga/plank-pose' calorieCnt="67"/>
            <SuggestedExercise name="Chair Pose" time="30s" exerciseIcn={chairIcn} path='/home/train-yoga/chair-pose' calorieCnt="22"/>
            <SuggestedExercise name="Plank" time="60s" exerciseIcn={plankIcn} path='/' calorieCnt="67"/>
            <SuggestedExercise name="Plank" time="60s" exerciseIcn={plankIcn} path='/' calorieCnt="67"/>
        </div>
     ...
     <div className="row-right">
        <div className="mini-stats-container">
          ...
          <div className="stat-item-container">
            ...
            <MiniStatCard newId="" text="45" imgSrc={calorieIcn}/>
            <MiniStatCard newId="smallIcn" text="45" imgSrc={clockIcn}/>
          </div>
